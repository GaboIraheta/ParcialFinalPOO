...
public abstract class DataBase implements ConnectionInterface { //00021223 clase para manejar todos los aspectos de consultas a la bbdd
    ...
    private static final String user = "MySQLxPOO"; //00042823 Depende de quien lo use, debe cambiarse
    private static final String password = "64867B0F"; //00042823 Depende de quien lo use, debe cambiarse
